...
def cos(a: int, b: int, c: int) -> int:
    """
    Return (cosine of a/b) * c in angle units.

    :param a: the numerator of the cosine
    :type a: int
    :param b: the denominator of the cosine
    :type b: int
    :param c: the multiplier for the cosine
    :type c: int

    :return: the cosine of a/b multiplied by c in angle units.
    :rtype int
    """
    return int(_degs_to_angle_units(math.degrees(math.cos(a / b))) * c)

def acos(a: int, b: int, c: int) -> int: 
    """
    Return (arc cosine of a/b) * c in angle units.

    :param a: the numerator of the arc cosine
    :type a: int
    :param b: the denominator of the arc cosine
    :type b: int
    :param c: the multiplier for the arc cosine
    :type c: int

    :return: the arc cosine of a/b multiplied by c in angle units.
    :rtype int
    """
    return int(_degs_to_angle_units(math.degrees(math.acos(a / b))) * c)

def sin(a: int, b: int, c: int) -> int:
    """
    Return (sine of a/b) * c in angle units.

    :param a: the numerator of the sine
    :type a: int
    :param b: the denominator of the sine
    :type b: int
    :param c: the multiplier for the sine
    :type c: int

    :return: the sine of a/b multiplied by c in angle units.
    :rtype int
    """
    return int(_degs_to_angle_units(math.degrees(math.sin(a / b))) * c)

def asin(a: int, b: int, c: int) -> int:
    """
    Return (arc sine of a/b) * c in angle units.

    :param a: the numerator of the arc sine
    :type a: int
    :param b: the denominator of the arc sine
    :type b: int
    :param c: the multiplier for the arc sine
    :type c: int

    :return: the arc sine of a/b multiplied by c in angle units.
    :rtype int
    """
    return int(_degs_to_angle_units(math.degrees(math.asin(a / b))) * c)

def tan(a: int, b: int, c: int) -> int:
    """
    Return (tangent of a/b) * c in angle units.

    :param a: the numerator of the tangent
    :type a: int
    :param b: the denominator of the tangent
    :type b: int
    :param c: the multiplier for the tangent
    :type c: int

    :return: the tangent of a/b multiplied by c in angle units.
    :rtype int
    """
    return int(_degs_to_angle_units(math.degrees(math.tan(a / b))) * c)

def atan(a: int, b: int, c: int) -> int:
    """
    Return (arc tangent of a/b) * c in angle units.

    :param a: the numerator of the arc tangent
    :type a: int
    :param b: the denominator of the arc tangent
    :type b: int
    :param c: the multiplier for the arc tangent
    :type c: int

    :return: the arc tangent of a/b multiplied by c in angle units.
    :rtype int
    """
    return int(_degs_to_angle_units(math.degrees(math.atan(a / b))) * c)
...
def exp(a: int, b: int, c: int) -> int:
    ...
    :type b: int
    :param c: the multiplier for the exponent
    :type c: int

    :return: the result of exp(a/b) * c
    :rtype: int
    """

    return int(math.exp(a / b) * c)

def log(a: int, b: int, c: int) -> int:
    """Return (natural logarithm of a/b) * c.

    :param a: the numerator of the logarithm
    :type a: int
    :param b: the denominator of the logarithm
    :type b: int
    :param c: the multiplier for the logarithm
    :type c: int

    :return: the result of (natural logarithm of a/b) * c
    :rtype: int
    """

    return int(math.log(a / b) * c)

def log10(a: int, b: int, c: int) -> int:
    """Return (base 10 logarithm of a/b) * c.
    ...
    :return: the result of (base 10 logarithm of a/b) * c
    :rtype: int
    """

    return int(math.log10(a / b) * c)

def power(a: int, b: int, c: int, d: int) -> int:
    """Return a over b raised to the power of c, multiplied by d.

    :param a: the numerator of the base
    :type a: int
    :param b: the denominator of the base
    :type b: int
    ...
    return int(math.pow(a/b, c) * d)

def sqrt(a: int, b: int) -> int:
    """Return the square root of `a` multiplied by `b`.
...
def root(a: int, b: int, c: int, d: int) -> int:
    """Calculate c - sqrt(a/b) * d.

    :param a: the numerator of the radicand
    :type a: int
    :param b: the denominator of the radicand
    :type b: int
    :param c: the constant to subtract the result from
    :type c: int
    :param d: the multiplier for the square root
    :type d: int
    :return: the result of c - sqrt(a/b) * d
    :rtype: int
    """
    return int((c - math.sqrt(a/b))*d)
